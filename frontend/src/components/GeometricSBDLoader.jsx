  ...
  <g filter="url(#sbdGlow)">
    ...
    { isSideView ? (
      ...
      <>
        ...
        <circle cx="0" cy="0" r={ plate * 1.35 } fill="#10b981" />
        { /* Détail intérieur du disque */ }
        <circle cx="0" cy="0" r={ plate * 0.7 } fill="#a7f3d0" opacity="0.8" />
        { /* Extrémité de la barre (Sleeve) */ }
        <circle cx="0" cy="0" r="2.5" fill="#d1d5db" />
        { /* Centre creux de la barre */ }
        <circle cx="0" cy="0" r="1" fill="#022c22" />
      </>
    ) : (
      // --- VUE DE FACE (Squat et Deadlift) ---
      <>
        <line x1={ -span } y1="0" x2={ span } y2="0" stroke="#d1d5db" strokeWidth="3" strokeLinecap="round" />
        <circle cx={ -span } cy="0" r={ plate } fill="#10b981" />
        <circle cx={ span } cy="0" r={ plate } fill="#10b981" />
        <circle cx={ -span } cy="0" r={ plate * 0.42 } fill="#a7f3d0" />
        <circle cx={ span } cy="0" r={ plate * 0.42 } fill="#a7f3d0" />
        <circle cx={ -span + 6 } cy="0" r="2.4" fill="#34d399" />
        <circle cx={ span - 6 } cy="0" r="2.4" fill="#34d399" />
      </>
    ) }
  </g>
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 sm:p-8 w-full">
      ...
      <div className="relative w-full max-w-lg">
        <div className="absolute -inset-6 bg-emerald-500/[0.07] blur-3xl rounded-full" />
        <svg
          viewBox="0 0 360 175"
        ...
        >
          ...
          <g opacity="0.14" fill="none" stroke="#9ca3af">
          ...
          { /* Platform */ }
          <line x1="20" y1="151" x2="340" y2="151" stroke="#374151" strokeWidth="2" strokeLinecap="round" opacity="0.7" />
          <line x1="20" y1="151" x2="340" y2="151" stroke="#34d399" strokeWidth="2" strokeLinecap="round" strokeDasharray="2 14" opacity="0.75" />

          { /* ============================= SQUAT ============================= */ }
          <g transform="translate(60,0)">
            <ellipse cx="0" cy="150" rx="16" ry="3" fill="#022c22">
            ...
            <path style={ { ...bodyStroke, strokeWidth: 3, stroke: '#d1d5db' } }>
          ...
          <g transform="translate(180,0)">
            <ellipse cx="0" cy="150" rx="26" ry="3" fill="#022c22" opacity="0.5" />
            { /* Bench */ }
            <rect x="-30" y="112" width="60" height="6" rx="3" fill="#4b5563" />
            <line x1="-22" y1="118" x2="-22" y2="140" stroke="#374151" strokeWidth="3" strokeLinecap="round" />
            <line x1="22" y1="118" x2="22" y2="140" stroke="#374151" strokeWidth="3" strokeLinecap="round" />
            ...
            <circle cx="-22" cy="104" r="6.5" fill="#d1d5db" />
          ...
          { /* Discipline labels */ }
          <g fontFamily="monospace" fontSize="8" fontWeight="700" letterSpacing="2" fill="#9ca3af" textAnchor="middle">
            <text x="60" y="168">
              SQUAT
      ...
      <div className="mt-8 flex flex-col items-center gap-4 w-full max-w-sm">
        <div
          ...
          style={ {
            backgroundImage: 'linear-gradient(90deg,#4b5563,#e5e7eb,#34d399,#e5e7eb,#4b5563)',
